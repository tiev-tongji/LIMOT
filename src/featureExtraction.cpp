...
public:
    ...
    FeatureExtraction() {
        subLaserCloudInfo = nh.subscribe<limot::cloud_info>("limot/deskew/cloud_info", 1, &FeatureExtraction::laserCloudInfoHandler, this, ros::TransportHints().tcpNoDelay());
        pubLaserCloudInfo = nh.advertise<limot::cloud_info>("limot/feature/cloud_info", 1);
        pubCornerPoints = nh.advertise<sensor_msgs::PointCloud2>("limot/feature/cloud_corner", 1);
        pubSurfacePoints = nh.advertise<sensor_msgs::PointCloud2>("limot/feature/cloud_surface", 1);
        initializationValue();
    }
